...
const MacbookScroll = ({
  ...
  if (size.width && size.height) {
    ...
    if (size.width < 768) {
      ...
      if (size.height >= 830 && size.height < 850 && lidTranslateInputRange[1] !== 1700) {
        setLidTranslateInputRange([0, 1700]);
        setBottomContentTranslateInputRange([0, 1700]);
      }
  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-white mb-20 w-full"
      >
        { bottomContent }
      </motion.h2>
    </div>
