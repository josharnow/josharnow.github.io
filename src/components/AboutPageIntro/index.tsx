  ...
  return (
    ...
    <AuroraBackground className="min-h-fit h-full w-full">
      <motion.div
        ...
        className="h-fit px-6 py-0 sm:py-32 sm:px-24"
        // className="min-h-full px-6 py-24 sm:py-32 sm:px-24"
      >
        <div className="h-full min-h-fit relative flex flex-col justify-between">
          ...
          <div className="w-full flex grow justify-end">
            <div className="h-full flex w-3/6 text-right justify-end" style={ { "textAlign": "justify" } }>
          ...
          <div className="flex flex-col grow justify-end text-white w-3/6 text-3xl lg:text-4xl">
            {/* <div className="text-white w-3/6 text-3xl sm:text-4xl"> */ }
            {/* TODO - Typewriter Aceternity effect */ }
            <p className="">
