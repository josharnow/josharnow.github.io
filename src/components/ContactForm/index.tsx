          ...
          <FormInput id="message" placeholder="Your message" name="message" className="h-20" inputElement={(
            <>
              <textarea id="message" name="message" placeholder="Your message"
                  className="flex h-full w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
